...
- [ ] Feature (adds a new feature to the package) - `feat(...)`, requires a minor version update
...
[comment]: <> (- [ ] CodeCov for patch has met target &#40;all changes/updates have been tested&#41;)
